...
Shader "Retus001/CellShaded" {
    Properties {
        ...
        _LightColor ("LightColor", Color) = (0.9339623,0.9339623,0.9339623,1)
        _ShadowColor ("ShadowColor", Color) = (0.2358491,0.2358491,0.2358491,1)
        _CellShadingBalance ("CellShadingBalance", Range(0, 1)) = 0.2
        ...
        _pannSpeed ("pannSpeed", Range(-5, 5)) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 _PannU_var = lerp( i.uv0, (i.uv0+node_1086*float2(1,0)), _PannU );
                float2 _PannV_var = lerp( i.uv0, (i.uv0+node_1086*float2(0,1)), _PannV );
                float2 node_8428 = (_PannU_var+_PannV_var);
                float2 UVPann = (node_8428-i.uv0);
...
////// Emissive:
                ...
                float3 node_5195 = saturate(max(node_8224,_LightColor.rgb));
                float3 finalColor = emissive + (_LightColor0.rgb*lerp((node_9548_if_leA*saturate(max(node_8224,_ShadowColor.rgb)))+(node_9548_if_leB*node_5195),node_5195,node_9548_if_leA*node_9548_if_leB)*attenuation);
...
////// Lighting:
                ...
                float3 node_8224 = Diffuse;
                float3 node_5195 = saturate(max(node_8224,_LightColor.rgb));
                float3 finalColor = (_LightColor0.rgb*lerp((node_9548_if_leA*saturate(max(node_8224,_ShadowColor.rgb)))+(node_9548_if_leB*node_5195),node_5195,node_9548_if_leA*node_9548_if_leB)*attenuation);
